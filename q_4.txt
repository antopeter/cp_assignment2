In this program we are using two rand() function here 2 number are generated .

Then Using "dice1=1+rand()%6" .
Here one value is generated and it is similarly for the "dice2"

Switch statement we can found sum 
